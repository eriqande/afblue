## This code calculates effective sample size based on empirical variance of P
## See the file "Sims.R" for code that analyzes Fst and Ne and does additional anlayses of allele frequency
## This version also adds Yank2 and BLUE analyses
...
All = cbind(AllS,AllESS)
rownames(All) = c("Full","BLUE", "Yank2","25","50","75","90","95","100")
All
##cat(AllESS,sep="\n")
AllESS[2]/AllESS[1]  # ratio of ESS for BLUE compared to full sample; see Figure 8
