...
The maximimum likelihood estimate and the method of moments estimate of the frequency $p$ of an allele $A$ from a sample of
...
or eliminated from, respectively, the sample. Note that if every $z_i = 1$ then this estimator clearly reduces to the 
...
$1+f_i$ where $f_i$ is the inbreeding coefficient of individual $i$.
